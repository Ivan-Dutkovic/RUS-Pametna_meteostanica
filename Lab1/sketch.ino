...
void ISR_INT0(){ handleInterrupt(0, LED_INT0, "INT0 (HIGH priority) triggered"); }
void ISR_INT1(){ handleInterrupt(1, LED_INT1, "INT1 (MEDIUM priority) triggered"); }
void ISR_INT2(){ handleInterrupt(2, LED_INT2, "INT2 (LOW priority) triggered"); }
